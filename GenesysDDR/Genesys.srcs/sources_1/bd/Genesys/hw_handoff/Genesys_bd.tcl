...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set pingpong_clk_0 [ create_bd_port -dir O pingpong_clk_0 ]
  ...
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins axi_smc/aclk1] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_mig_7series_0_225M/slowest_sync_clk]
