...
################################################################
# This is a generated script based on design: Genesys
#
...
proc write_mig_file_Genesys_mig_7series_0_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {  <ModuleName>Genesys_mig_7series_0_0</ModuleName>}
...
# End of write_mig_file_Genesys_mig_7series_0_0()
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set clk_dac_0 [ create_bd_port -dir O clk_dac_0 ]
  set clk_dac_1 [ create_bd_port -dir O clk_dac_1 ]
  set dac_sync_1 [ create_bd_port -dir O dac_sync_1 ]
  set data_out_0 [ create_bd_port -dir O data_out_0 ]
  set data_out_1 [ create_bd_port -dir O data_out_1 ]
  set led_0 [ create_bd_port -dir O -from 7 -to 0 led_0 ]
  set load_0 [ create_bd_port -dir I load_0 ]
  set load_1 [ create_bd_port -dir I load_1 ]
  set pingpong_clk_1 [ create_bd_port -dir O pingpong_clk_1 ]
  set reset [ create_bd_port -dir I -type rst reset ]
  set_property -dict [ list \
   CONFIG.POLARITY {ACTIVE_LOW} \
 ] $reset
  set resetdac_0 [ create_bd_port -dir I resetdac_0 ]
  set resetout_0 [ create_bd_port -dir O resetout_0 ]
  set rst_0 [ create_bd_port -dir I rst_0 ]
  set rst_1 [ create_bd_port -dir I rst_1 ]
  set rst_2 [ create_bd_port -dir I rst_2 ]

  # Create instance: DAC_PSI_0, and set properties
  set DAC_PSI_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:DAC_PSI:1.0 DAC_PSI_0 ]

  # Create instance: DAC_driver_0, and set properties
  set DAC_driver_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:DAC_driver:1.0 DAC_driver_0 ]
  ...
  write_mig_file_Genesys_mig_7series_0_0 $str_mig_file_path
  ...
  # Create instance: pingpong_clk_0, and set properties
  set pingpong_clk_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:pingpong_clk:1.0 pingpong_clk_0 ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M02_AXI [get_bd_intf_pins microblaze_0_axi_periph/M02_AXI] [get_bd_intf_pins pingpong_clk_0/S00_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M03_AXI [get_bd_intf_pins DAC_PSI_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M04_AXI [get_bd_intf_pins DAC_driver_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M04_AXI]
  ...
  # Create port connections
  connect_bd_net -net DAC_PSI_0_clk_dac [get_bd_ports clk_dac_1] [get_bd_pins DAC_PSI_0/clk_dac]
  connect_bd_net -net DAC_PSI_0_dac_sync [get_bd_ports dac_sync_1] [get_bd_pins DAC_PSI_0/dac_sync]
  connect_bd_net -net DAC_PSI_0_data_out [get_bd_ports data_out_1] [get_bd_pins DAC_PSI_0/data_out]
  connect_bd_net -net DAC_driver_0_clk_dac [get_bd_ports clk_dac_0] [get_bd_pins DAC_driver_0/clk_dac]
  connect_bd_net -net DAC_driver_0_data_out [get_bd_ports data_out_0] [get_bd_pins DAC_driver_0/data_out]
  connect_bd_net -net DAC_driver_0_resetout [get_bd_ports resetout_0] [get_bd_pins DAC_driver_0/resetout]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins DAC_PSI_0/clk] [get_bd_pins DAC_driver_0/clk] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net load_0_1 [get_bd_ports load_0] [get_bd_pins DAC_driver_0/load]
  connect_bd_net -net load_1_1 [get_bd_ports load_1] [get_bd_pins DAC_PSI_0/load]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins DAC_PSI_0/s00_axi_aclk] [get_bd_pins DAC_driver_0/s00_axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins mdm_1/M_AXI_ACLK] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mig_7series_0/ui_addn_clk_0] [get_bd_pins pingpong_clk_0/clk] [get_bd_pins pingpong_clk_0/s00_axi_aclk] [get_bd_pins rst_mig_7series_0_100M/slowest_sync_clk] [get_bd_pins system_ila/clk]
  connect_bd_net -net mig_7series_0_mmcm_locked [get_bd_pins mig_7series_0/mmcm_locked] [get_bd_pins rst_mig_7series_0_100M/dcm_locked] [get_bd_pins rst_mig_7series_0_225M/dcm_locked]
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins axi_smc/aclk1] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_mig_7series_0_225M/slowest_sync_clk]
  ...
  connect_bd_net -net pingpong_clk_0_led [get_bd_ports led_0] [get_bd_pins pingpong_clk_0/led]
  connect_bd_net -net pingpong_clk_0_pingpong_clk [get_bd_ports pingpong_clk_1] [get_bd_pins pingpong_clk_0/pingpong_clk]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins mig_7series_0/sys_rst] [get_bd_pins reset_inv_0/Op1] [get_bd_pins rst_mig_7series_0_100M/ext_reset_in]
  connect_bd_net -net reset_inv_0_Res [get_bd_pins clk_wiz_0/reset] [get_bd_pins reset_inv_0/Res]
  connect_bd_net -net resetdac_0_1 [get_bd_ports resetdac_0] [get_bd_pins DAC_driver_0/resetdac]
  connect_bd_net -net rst_0_1 [get_bd_ports rst_0] [get_bd_pins pingpong_clk_0/rst]
  connect_bd_net -net rst_1_1 [get_bd_ports rst_1] [get_bd_pins DAC_driver_0/rst]
  connect_bd_net -net rst_2_1 [get_bd_ports rst_2] [get_bd_pins DAC_PSI_0/rst]
  ...
  connect_bd_net -net rst_mig_7series_0_100M_peripheral_aresetn [get_bd_pins DAC_PSI_0/s00_axi_aresetn] [get_bd_pins DAC_driver_0/s00_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins mdm_1/M_AXI_ARESETN] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins pingpong_clk_0/s00_axi_aresetn] [get_bd_pins rst_mig_7series_0_100M/peripheral_aresetn] [get_bd_pins system_ila/resetn]
  connect_bd_net -net rst_mig_7series_0_225M_peripheral_aresetn [get_bd_pins mig_7series_0/aresetn] [get_bd_pins rst_mig_7series_0_225M/peripheral_aresetn]

  # Create address segments
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces mdm_1/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0x00000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces mdm_1/Data] [get_bd_addr_segs microblaze_0_local_memory/dlmb_bram_if_cntlr/SLMB1/Mem] -force
  assign_bd_address -offset 0x80000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces mdm_1/Data] [get_bd_addr_segs mig_7series_0/memmap/memaddr] -force
  assign_bd_address -offset 0x44A10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs DAC_PSI_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x44A20000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs DAC_driver_0/S00_AXI/S00_AXI_reg] -force
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs pingpong_clk_0/S00_AXI/S00_AXI_reg] -force
