...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = DAC_PSI
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = DAC_PSI_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = DAC_driver
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = DAC_driver_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = pingpong_clk
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = pingpong_clk_0
END
